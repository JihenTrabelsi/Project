...
const KYC1 = artifacts.require("KYC1");
const KYC2 = artifacts.require("KYC2");
...
module.exports = function (deployer, network, accounts) {
  ...
  if (network == "development") {
    ...
    //deployer.deploy(KYC, "Suresh", "suresh@geekyants.com");
     deployer.deploy(KYC2, "Suresh", "suresh@geekyants.com"); 
    deployer.deploy(KYC1, "Suresh", "suresh@geekyants.com");
